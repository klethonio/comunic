...
if(!file_exists($current_path.$rfm_subfolder)){ mkdir($current_path.$rfm_subfolder);}
if(!file_exists($current_path.$rfm_subfolder.$subdir)){ mkdir($current_path.$rfm_subfolder.$subdir);}
