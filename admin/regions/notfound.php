...
<?php
		if(!empty($_POST['sendForm'])){
			...
			if(count(array_unique($f)) != count($f) ){
				...
				for($i = 0, $j = 4; $i < 4; $i++, $j++){
					update('cuc_regions', array('category' => $f[$i]), 'WHERE region=?', array($j), 'ii');
				}
...
?>
                ...
                <div id="region-site">
                <div id="notfound">SLIDE</div>
                <div id="notfoung1">AREA 1</div>
                <div id="notfoung2">AREA 2</div>
                <div id="notfoung3">AREA 3</div>
                <div id="notfoung4">AREA 4</div>
                </div>
                <div id="regions">
